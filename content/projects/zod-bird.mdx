...
repository: evanschoffstall/zod-bird
date: "2023-05-21"
published: true
...
```ts
import { Tinybird } from "@evanschoffstall/zod-bird";
import { z } from "zod";
...
const res = await getEvents({ tenantId: "evanschoffstall" })
...
```
npm i @evanschoffstall/zod-bird
```
