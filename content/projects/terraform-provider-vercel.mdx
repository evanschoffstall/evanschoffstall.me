...
date: "2021-03-16"
repository: evanschoffstall/terraform-provider-vercel
url: https://registry.terraform.io/providers/evanschoffstall/vercel/latest
published: true
---
...
terraform {
  required_providers {
    vercel = {
      source  = "registry.terraform.io/evanschoffstall/vercel"
      version = ">=0.10.3"
    }
  }
}
...
resource "vercel_project" "my_project" {
  ...
  git_repository {
    type = "github"
    repo = "evanschoffstall/terraform-provider-vercel"
  }
}
```
...
Now that Vercel have stepped in, I have decided to [deprecate](https://twitter.com/evanschoffstall_/status/1517759708983177218) this one on April 23rd 2022.
